...
class Platforms extends Component {
    ...
    gameNumSortHandler = () => {
        ...
        const sortedPlats = mostPlatforms.sort((a, b) => b.games_count - a.games_count)
    ...
    if (this.state.allPlatforms[1].name !== 'iOS') {
        ...
        const reSortedPlats = mostPlatforms.sort((b, a) => b.games_count - a.games_count)
        this.setState({
    ...
    render() {
        ...
        <button className="theButton" onClick={this.gameNumSortHandler}>Sort by highest number of games:</button>
        {
